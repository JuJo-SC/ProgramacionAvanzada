...
public class ControladorContexto {
    ...
    public void actualizarComboProductosVenta() {
        ...
        Iterator<Producto> iterator = gestor.getProductos().iterator();
        while (iterator.hasNext()) {
            Producto p = iterator.next();
    ...
    public Producto construirProductoDesdeFormulario() {
        ...
        String precioVentaTexto = vistaProductos.txtPrecioVenta.getText().trim();
        ...
        return servicioProductos.construirProducto(idTexto, codigo, nombre, descripcion, categoria, precioCompraTexto, precioVentaTexto, stockTexto, stockMinimoTexto, activo);
    }
